      ...
      websocket.onmessage = function(e){
    	  ...
    	  if (data.state=="start"){
    		  ...
    		  $("#actionSub").submit();  //提交考试页面的表单
    		    ...
    		    var s=0;
    		    if(t>=0){
    		      d=Math.floor(t/1000/60/60/24);  //转换为天
    		      h=Math.floor(t/1000/60/60%24);  //转换为小时
    		      m=Math.floor(t/1000/60%60);     //转换为分钟
    		      s=Math.floor(t/1000%60);        //转换为秒
    		    }
    		    //显示剩余时间
